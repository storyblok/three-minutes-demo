...
function program1(depth0,data) {
  ...
  buffer += "\n	"
    + escapeExpression((helper = helpers.blok || (depth0 && depth0.blok),options={hash:{},data:data},helper ? helper.call(depth0, depth0, options) : helperMissing.call(depth0, "blok", depth0, options)))
    + "\n";
  return buffer;
  }
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\">\n	<!-- FLEX: teaser.html -->\n	<!-- no index start -->\n	<div class=\"teaser-content no-wrap\n	text-on-bottom\n	\">\n\n	<a href=\"\" target=\"_self\" data-tracking-id=\"\">\n		<img src=\"";
...
},{"../bloks/root.hbs":1,"../bloks/teaser.hbs":2,"hbsfy/runtime":10}]},{},[11]);
